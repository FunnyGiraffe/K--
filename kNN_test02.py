...
def showdatas(datingDataMat, datingLabels):
    ...
    # 将nrow=2，nclos=2时，代表fig画布被分为四个区域，axs[0][0]表示第一行第一个区域
    ...
    # 画出散点图，以datingDataMat矩阵的第一列（飞行常客里程），第二列（玩游戏）数据画散点数据，散点大小为15，透明度为0.5
    ...
    # 画出散点图，以datingDataMat矩阵的第一列（飞行常客历程），第三列（冰激凌）数据画散点数据，散点大小为15，透明度为0.5
    ...
    # 画出散点图，以datingDataMat矩阵的第二列（玩游戏），第三列（冰激凌）数据花散点数据，散点大小为15，透明度为0.5
...
if __name__ == '__main__':
    # 打开的文件名
    fileName = u"F:\PythonWorkspace\K-邻近算法\datingTestSet.txt"
    # 打开并处理数据
